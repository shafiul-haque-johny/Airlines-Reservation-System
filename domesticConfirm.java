 ...
 * @author Tushar
 */
public class domesticConfirm extends javax.swing.JFrame {

    /**
     * Creates new form domesticConfirm
     */
    public domesticConfirm() {
        initComponents();
    }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
            ...
            if(global.Class.equals("Economy"))
            {
                    ...
                    int adultP=3500*Integer.valueOf(global.adult);
                    global.total_price+=adultP;
                    
                    
                    int infantP= 2500*Integer.valueOf(global.infant);
                    global.total_price+=infantP;
                    
                    int childP= 3000*Integer.valueOf(global.child);
           ...
           else if(global.Class.equals("Business"))
            {
                    ...
                    int adultP=2* 3500*Integer.valueOf(global.adult);
                    global.total_price+=adultP;
                    
                    
                    int infantP=2* 2500*Integer.valueOf(global.infant);
                    global.total_price+=infantP;
                    
                    int childP=2*3000*Integer.valueOf(global.child);
                    global.total_price+=childP;
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        try {
            BufferedWriter w = new BufferedWriter(new FileWriter("domestic.txt", true));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(domesticConfirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new domesticConfirm().setVisible(true);
            }
        });
    }
